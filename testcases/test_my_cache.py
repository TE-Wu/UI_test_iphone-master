...
class Test_My_Cache(unittest.TestCase):
    ...
    def test_1(self):
        ...
        self.mvobj.my_down().click()
        print('缓存页 第一位：'+self.mydown.donwload_name())
        self.mydown.donwload_click().click()
        ...
        print('选中的影片是：'+self.mydown.first_movie_name()+''+self.mydown.first_movie_name2()+''+self.mydown.first_movie_name3())
        ...
        print('删除后的列表第一位名称：'+self.mydown.first_movie_name()+''+self.mydown.first_movie_name2())
        print('回到首页')
