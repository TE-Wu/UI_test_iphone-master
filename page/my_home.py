...
class My_Home:
    ...
    def logout_in(self):
        return self.find.get_element('MyMore', 'logout_in')

    def logout_cannel(self):
        return self.find.get_element('MyMore', 'logout_cannel')
    ...
    # 南瓜商城
    def store(self):
        return self.find.get_element('MyMore', 'store')

    # 我的会员
    def member(self):
        return self.find.get_element('MyMore', 'member')
